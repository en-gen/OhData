...
| [![EnGen.OhData.AspNetCore.Mapper](https://img.shields.io/nuget/v/EnGen.OhData.AspNetCore.Mapper?label=EnGen.OhData.AspNetCore.Mapper)](https://www.nuget.org/packages/EnGen.OhData.AspNetCore.Mapper) | Optional. Serve a DTO that differs from your EF Core entity, with the query still in SQL — [reads](docs/api-model-mapping.md), [writes](docs/delta-mapping.md). |
