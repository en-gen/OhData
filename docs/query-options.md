...
>
> **A delegate-backed navigation is outside all four rows** (#313 O6): its rows are what your `Handler`/`BatchHandler` returned, and the framework neither truncates nor rejects those. Bound them in the delegate.
>
