...
public sealed class PcCustomerProfile : EntitySetProfile<int, PcCustomer>
{
    ...
    public PcCustomerProfile() : base(x => x.Id)
    {
        ...
        GetById = (id, _) => OhDataResult.SuccessTask<PcCustomer>(new PcCustomer { Id = id });
        ...
        Patch = (id, delta, _) =>
        {
            ...
            delta.Patch(row);
            LastPatched = row;
            return OhDataResult.SuccessTask<PcCustomer>(row);
        };
    }
}
...
public sealed class PcOrderProfile : EntitySetProfile<int, PcOrder>
{
    ...
    public PcOrderProfile() : base(x => x.OrderId)
    {
        ...
        GetById = (id, _) => OhDataResult.SuccessTask<PcOrder>(new PcOrder { OrderId = id });
        ...
        Patch = (id, delta, _) =>
        {
            ...
            delta.Patch(row);
            return OhDataResult.SuccessTask<PcOrder>(row);
        };
    }
}
