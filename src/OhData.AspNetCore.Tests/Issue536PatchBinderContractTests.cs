...
public sealed class PcCustomerProfile : EntitySetProfile<int, PcCustomer>
{
    ...
    public PcCustomerProfile() : base(x => x.Id)
    {
        ...
        GetById = (id, _) => Task.FromResult<PcCustomer?>(new PcCustomer { Id = id });
        ...
        Patch = (id, delta, _) =>
        {
            ...
            delta.Patch(row);
            LastPatched = row;
            return Task.FromResult<PcCustomer?>(row);
        };
    }
}
...
public sealed class PcOrderProfile : EntitySetProfile<int, PcOrder>
{
    ...
    public PcOrderProfile() : base(x => x.OrderId)
    {
        ...
        GetById = (id, _) => Task.FromResult<PcOrder?>(new PcOrder { OrderId = id });
        ...
        Patch = (id, delta, _) =>
        {
            ...
            delta.Patch(row);
            return Task.FromResult<PcOrder?>(row);
        };
    }
}
